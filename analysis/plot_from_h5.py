...
if __name__ == "__main__":
    ...
    plot_solidFraction_RMSF(h5metrics, output_dir, numSamples=3, simplified=False, repl='1')
    plot_solidFraction_vs_numResidues(h5metrics, output_dir, mean_across='all', temps=None, simplified=False)
    plot_heatmap_ss_time_superfamilies(h5metrics, output_dir, mean_across='all', temps=None, num_pdbs=None, simplified=False)
    plot_ternary_superfamilies(h5metrics, output_dir, mean_across='all', temps=None, num_pdbs=None, simplified=False)
